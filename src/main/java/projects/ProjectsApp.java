...
public class ProjectsApp {
	...
	private Project curProject;
		...
		// This method prints the operations, gets a user menu selection, and
		//  performs the requested operation. It repeats until the user requests
		//  that the application terminate.
